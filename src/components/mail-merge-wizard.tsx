...
const mockDataFile = {
  ...
  rows: [
    { TIPO_COMP: 'FACTURA', RUC: '0992124857001', RAZON_SOCIAL_EMISOR: 'Mi Empresa S.A.C', SERIE_COMPROBANTE: 'F001-0200', OBSERVACIONES: 'Deuda S/ 300.00, vence 2024-09-10' },
    { TIPO_COMP: 'FACTURA', RUC: '0992124857001', RAZON_SOCIAL_EMISOR: 'Mi Empresa S.A.C', SERIE_COMPROBANTE: 'F001-0215', OBSERVACIONES: 'Deuda S/ 750.50, vence 2024-09-25' },
    { TIPO_COMP: 'FACTURA', RUC: '1790241483001', RAZON_SOCIAL_EMISOR: 'Otra Empresa S.R.L.', SERIE_COMPROBANTE: 'E001-888', OBSERVACIONES: 'Deuda S/ 4500.00, vence 2024-08-30' },
    { TIPO_COMP: 'BOLETA', RUC: '0190007510001', RAZON_SOCIAL_EMISOR: 'Mi Empresa S.A.C', SERIE_COMPROBANTE: 'B001-1123', OBSERVACIONES: 'Deuda S/ 250.00, vence 2024-09-12' },
  ],
};
