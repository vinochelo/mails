  ...
  return (
    <div className="w-full animate-in fade-in-50 duration-500">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-2">Se encontraron {data.size} emisores. Revisa los detalles y personaliza tu correo.</p>
      </div>
                ...
                <CardContent className="p-6 space-y-4">
                    <Tabs defaultValue="edit" className="w-full">
                        ...
                        <TabsContent value="preview">
                            <div className="p-6 bg-secondary/20 rounded-xl border-2 border-dashed min-h-[350px] text-sm whitespace-pre-wrap leading-relaxed shadow-inner">
                     ...
                     <Alert className="bg-primary/5 border-primary/20">
                        ...
                        <AlertDescription>
                            <p className="font-bold mb-2 text-primary text-xs uppercase tracking-wider">Etiquetas:</p>
                            <ul className="space-y-1 text-xs">
                                {availableTags.map(t => (
                                    <li key={t.tag} className="flex flex-col gap-0.5">
                                        <code className="font-bold text-accent">{t.tag}</code>
                                        <span className="text-muted-foreground italic text-[10px]">{t.description}</span>
                                    </li>
                                ))}
                            </ul>
                        </AlertDescription>
