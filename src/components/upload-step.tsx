...
interface UploadStepProps {
  onProcess: () => void;
  onRecipientsUpload: (file: File) => void;
  onInvoicesUpload: (file: File) => void;
...
const FileUploader = ({ 
  ...
  return (
    <Card className="hover:border-primary/50 hover:shadow-lg transition-all">
      ...
      <CardContent>
        <div
          className="flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-border p-8 text-center"
    ...
    <div className="w-full animate-in fade-in-50 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <FileUploader 
            ...
            description="Debe contener: RUC, código, nombre, correo."
            icon={Users}
